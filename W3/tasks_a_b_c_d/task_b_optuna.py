...
if __name__ == '__main__':
    ...
    miners = [easy_hard_miner, pair_margin_miner]
    ...
    def objective(trial):
        ...
        #SAVE_WEIGHTS_PATH = os.path.join(SAVE_WEIGHTS_PATH, "task_b", unique_filename+".pt")
        ...
        # ------------------------------------------------------------------------
        SAVE_RESULTS_PATH = config["SAVE_RESULTS_PATH"]
        SAVE_RESULTS_PATH = os.path.join(SAVE_RESULTS_PATH, "task_b.json")
        result = {

...
from task_a import ImageEmbeddingLayer, TextEmbeddingLayer, Model
...
if __name__ == "__main__":
    ...
    if not USE_PICKLE_INFO:
        #LOAD SAVED MODEL
        #========================================================
        WEIGHT_SAVE_PATH_TXT = './weights/text_model_task_a_1epoch.pth'
        WEIGHT_SAVE_PATH_IMG = './weights/image_model_task_a_1epoch.pth'
    ...
    imgs_embds_retrieve, captions_embds_retrieve, ids_retrieve, _ = get_embeddings(img_model, txt_model, dataloader_val, max_samples=200, save_pickles=False)

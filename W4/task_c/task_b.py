...
class Model():
    ...
    def train_img_to_text(self, dataloader, n_epochs=1, save_path='./weights/model_img_task_c_b_1epoch.pth') -> None:
        ...
        for epoch in range(n_epochs):
            ...
            for batch_idx, (anchor_img, captions, _) in pbar:
                ...
                loss = self.triplet_loss(pos_embds, anchor_out, neg_embds)
                loss.backward()
                self.optimizer.step()

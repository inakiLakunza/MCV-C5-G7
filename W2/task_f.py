...
PATH_PARENT_DIRECTORY = "/ghome/group07/mcv/datasets/C5/out_of_context"
...
try_img_path = PATH_PARENT_DIRECTORY +'/im033.jpg'
...
save_img(try_img, output, "out_of_cntxt_33.png", cfg)

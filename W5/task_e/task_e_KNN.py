...
if __name__ == "__main__":
    ...
    if not USE_PICKLE_INFO:
        #LOAD SAVED MODEL
        #========================================================
        WEIGHT_SAVE_PATH_TXT = '/ghome/group07/C5-W5/task_e/weights_5_epochs/text_model_task_e_1epoch_All.pth'
        WEIGHT_SAVE_PATH_IMG = '/ghome/group07/C5-W5/task_e/weights_5_epochs/image_model_task_e_1epoch_All.pth'
        ...
        #     image_id='179159',
        #     id=217192,
        #     caption='A herd of elephant forages through a field.',
        #     index=499
        # )
        dataset_train.append_known_image(
            image_id='509693',
            id=822914,
            caption='Two sheep grazing on a cloudy day in a beautiful grass field.',
            index=499
        )
        # dataset_train.append_known_image(
        #     image_id='56850',
        #     id=606694,
        #     caption='A zebra standing next to a large bird.',
        #     index=499
        # )
        # dataset_train.append_known_image(
        #     image_id='515387',
        #     id=766432,
        #     caption='Horses are an important asset to city police departments.',
        #     index=499
        # )
